...
**Observations**:
  ...
  - Angle does not impact the general observation from the prior plot
    where `thick = 0.081` values all have E values of \< 10,125 (the
    dotted blue line)
  - E for `thick = 0.022` seems consistent across all three angles
  - E for `thick = 0.081` also seems somewhat consistent across all
    three angles
