...
- My guess is that the difference is due to some data scrubbing - from [some Googling](https://www.codementor.io/@innat_2k14/titanic-kaggle-machine-learning-from-disaster-part-1-10gbvqzguc), it seems like this dataset is from Kaggle, and data is often pre-processed to make it usable
- Also, interestingly enough, the "Passengers" section of the [original Wikipedia article on the RMS Titanic](https://en.wikipedia.org/wiki/RMS_Titanic#Passengers) mentions "Titanic's passengers numbered approximately 1,317 people" despite supposedly referencing the other one (Sinking of the RMS Titanic)
