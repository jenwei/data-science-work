...
- Overall, there is an inverse relationship between thickness and E - as E increases, thickness decreases
  - However, this relationship is not supported by the data when `thick = 0.064` as the median E is greater than that of `thick = 0.032`
...
- Looking into the data more closely (i.e. by angle), the relationship between E and thickness becomes more questionable as the inverse relationship is supported by data when `angle = 45` but not when `angle = 0`
- However, E for `thick = 0.022` seem consistent across all three angles
- E for `thick = 0.081` also somewhat consistent across all three angles
...
- Unlike E, mu data seems more chaotic and doesn't seem to show a relationship between thickness and mu in general or by angle
